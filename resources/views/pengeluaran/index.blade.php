...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="front/assets/img/kaiadmin/favicon.ico"
      type="image/x-icon"
    />
    ...
    <script>
      WebFont.load({
        ...
        custom: {
          ...
          urls: ["front/assets/css/fonts.min.css"],
        },
        active: function () {
    ...
    <link rel="stylesheet" href="front/assets/css/plugins.min.css" />
    <link rel="stylesheet" href="front/assets/css/kaiadmin.min.css" />
  ...
  <body>
        ...
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="index.html" class="logo">
              <img
                src="front/assets/img/kaiadmin/logo_light.svg"
                alt="navbar brand"
                class="navbar-brand"
                height="20"
              />
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="{{ route('bank.index')}}">
                        ...
                        <span class="sub-item">Dompet</span>
                      </a>
                    </li>
                    <li>
      ...
      <div class="main-panel">
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="front/assets/img/jm_denis.jpg"
                                alt="Img Profile"
                              />
                            </div>
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="front/assets/img/chadengle.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="front/assets/img/mlane.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="front/assets/img/talha.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                      ...
                      <div class="notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="front/assets/img/profile2.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="front/assets/img/profile.jpg"
                        alt="..."
        ...
        <div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                <h3 class="fw-bold mb-3">Rekap Pengeluaran</h3>
                <h6 class="op-7 mb-2"></h6>
              </div>
              <div class="ms-md-auto py-2 py-md-0">
                <a href="{{ route('pengeluaran.create')}}" class="btn btn-primary btn-round">Tambah pengeluaran +</a>
              </div>
            </div>
            <table class="table">
                <thead>
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="front/assets/img/flags/id.png"
                                      alt="indonesia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr> --}}
                                {{-- <td>
                                  <div class="flag">
                                    <img
                                      src="front/assets/img/flags/us.png"
                                      alt="united states"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="front/assets/img/flags/au.png"
                                      alt="australia"
                                    />
                                  </div>
                                </td> --}}
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="front/assets/img/flags/ru.png"
                                      alt="russia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td> --}}
                                  {{-- <div class="flag">
                                    <img
                                      src="front/assets/img/flags/cn.png"
                                      alt="china"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="front/assets/img/flags/br.png"
                                      alt="brazil"
                                    />
                                  </div>
                                </td>
    ...
    <!--   Core JS Files   -->
    <script src="front/assets/js/core/jquery-3.7.1.min.js"></script>
    ...
    <!-- jQuery Vector Maps -->
    <script src="front/assets/js/plugin/jsvectormap/jsvectormap.min.js"></script>
    <script src="front/assets/js/plugin/jsvectormap/world.js"></script>

    <!-- Sweet Alert -->
    <script src="front/assets/js/plugin/sweetalert/sweetalert.min.js"></script>

    <!-- Kaiadmin JS -->
    <script src="front/assets/js/kaiadmin.min.js"></script>
